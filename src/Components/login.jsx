...
const Login = () => {
  const translations = {
    en: {
      ...
      loginButton: "Login",
      signupText: "Don’t have an account? <a href='signup.html'>Sign Up</a>",
    ...
    hi: {
      ...
      loginButton: "लॉगिन",
      signupText: "खाता नहीं है? <a href='signup.html'>साइन अप करें</a>",
  ...
  const handleSubmit = (e) => {
    ...
    setErrorMsg("");
    alert(
      `${translations[currentLanguage].loginButton} ${translations[currentLanguage].title}!\n${email}`
    );
